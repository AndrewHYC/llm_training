...
# 设置环境变量
os.environ['HF_TOKEN'] = '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' # 你的Hugging Face Token
...
def get_args():
    ...
    parser.add_argument("--model_path", type=str, default="./gemma-2b")
